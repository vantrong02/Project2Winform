...
namespace CafeManagement
{
    public partial class FQuanLyNhanVien : Form
    {
        ...
        private void QuanLyNhanVien_Load(object sender, EventArgs e)
        {
            ...
            LoadNhanVienList(NhanVienList);
        }
        public void LoadNhanVienList(DataTable NhanVienList)
        {
            lvNhanVien.Items.Clear();
        ...
        private void btnThemNV_Click(object sender, EventArgs e)
        {
            ...
            {
                DAL_NhanVien db = new DAL_NhanVien();
                DataTable dtNhanVien = db.getAllNhanVien();
        ...
        private void btnReset_Click(object sender, EventArgs e)
        {
            ...
            Enable();
            DAL_NhanVien db = new DAL_NhanVien();
            DataTable dt = db.getAllNhanVien();
            LoadNhanVienList(dt);
        }
        ...
        private void btnTinhLuongNV_Click(object sender, EventArgs e)
        {
            if (txtMaNV.Text != "")
            {
                ...
                DataTable dt = dbNV.getAllNhanVien();
                DAL_LuongMoiThang dbLuong = new DAL_LuongMoiThang();
                dbLuong.TinhLuongNhanVien(txtMaNV.Text, luong, status);
                LoadNhanVienList(dt);
        ...
        private void txtTenNV_TextChanged(object sender, EventArgs e)
        {
            ...
            DataTable dt = db_NhanVien.TimKiemNhanVienTheoTen(txtTenNV.Text);
            LoadNhanVienList(dt);
        }
    }
}
