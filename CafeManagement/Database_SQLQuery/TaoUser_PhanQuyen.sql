...
GRANT EXEC ON [dbo].[tinhThanhTien] TO ThanhToan
GRANT EXEC ON [dbo].[tinhTongHoaDon] TO ThanhToan
GRANT EXEC ON [dbo].[giamGia] TO ThanhToan
GRANT EXEC ON [dbo].[tinhSoTienPhaiTra] TO ThanhToan
...
GRANT EXEC ON [dbo].[fn_LayMaHoaDonHienTai] TO ThanhToan
...
GRANT EXEC ON [dbo].[sp_TinhSoGioLam] TO NhanOrder
GO
...
GRANT EXEC ON [dbo].[tinhLuong] TO QuanLyNhanVien
GRANT EXEC ON [dbo].[fn_CheckExist] TO QuanLyNhanVien -- Kiểm tra nhân viên đã được thanh toán lương của tháng đó chưa
GRANT INSERT, UPDATE ON LUONGMOITHANG TO QuanLyNhanVien
GO
...
GRANT EXEC ON [dbo].[fn_GetTenThucUong] TO QuanLyHoaDon
GRANT EXEC ON [dbo].[fn_LayMaHoaDonHienTai] TO  QuanLyHoaDon -- Trả về mã hóa đơn mới nhất trong ngày hiện tại
GRANT SELECT ON [dbo].[vi_ChiTietHoaDon] TO  QuanLyHoaDon
GO
